  ...
  /// ```
  public struct OrbitTransactionValueObservationScheduler<
  ...
  extension OrbitValueObservationMainActorScheduler {
    ...
    public func transaction(
      ...
      OrbitTransactionValueObservationScheduler(base: self, transaction: transaction)
    }

...
// executor needs, declared as wasi-libc exports them on a target built with threads.
  ...
  @_extern(c)
  func pthread_condattr_init(_ attributes: UnsafeMutablePointer<pthread_condattr_t>) -> Int32

  @_extern(c)
  func pthread_condattr_destroy(_ attributes: UnsafeMutablePointer<pthread_condattr_t>) -> Int32
  ...
  @_extern(c)
  func pthread_cond_signal(_ condition: UnsafeMutablePointer<pthread_cond_t>) -> Int32
